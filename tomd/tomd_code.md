# Project Archive: tomd
**Path:** `/home/bober/Desktop/Alexandria/tomd`
...
### File: tomd.egg-info/top_level.txt
```
tomd
...
### File: tomd.egg-info/entry_points.txt
```
[console_scripts]
collect_code = tomd:main

```

---

### File: tomd.egg-info/PKG-INFO
```
...
### File: tomd.egg-info/dependency_links.txt
```
...
### File: tomd.egg-info/SOURCES.txt
```
setup.py
tomd.py
tomd.egg-info/PKG-INFO
tomd.egg-info/SOURCES.txt
tomd.egg-info/dependency_links.txt
tomd.egg-info/entry_points.txt
tomd.egg-info/top_level.txt
```
